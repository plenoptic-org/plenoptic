...
class Linear_Nonlinear(nn.Module):
    ...
    n_channels: int, optional
        number of channels, by default three: low pass, high pass on / off.
    kernel_size : tuple of two ints
        size of the receptive field (odd size supported), [3x3] by default
    variance: int, optional
    """
    def __init__(self, n_channels=3, kernel_size=(3, 3), variance=3):
        super().__init__()
