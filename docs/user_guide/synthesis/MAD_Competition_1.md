...
:::{admonition} Setting the pixel range of MAD Competition with {attr}`~plenoptic.MADCompetition.penalty_function`
:class: dropdown note
...
using the argument {attr}`~plenoptic.MADCompetition.penalty_function`. The code
